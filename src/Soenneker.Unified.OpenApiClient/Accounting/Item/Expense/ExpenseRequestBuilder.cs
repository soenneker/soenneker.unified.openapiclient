...
{
    /// <summary>
    /// Builds and executes requests for operations under \accounting\{connection_id}\expense
    /// </summary>
    ...
    public partial class ExpenseRequestBuilder : BaseRequestBuilder
    {
        ...
        public ExpenseRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounting/{connection_id}/expense{?category_id*,contact_id*,end_lt*,fields*,group_id*,limit*,offset*,order*,org_id*,query*,raw*,sort*,start_gte*,updated_gte*,user_id*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Unified.OpenApiClient.Accounting.Item.Expense.ExpenseRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ExpenseRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounting/{connection_id}/expense{?category_id*,contact_id*,end_lt*,fields*,group_id*,limit*,offset*,order*,org_id*,query*,raw*,sort*,start_gte*,updated_gte*,user_id*}", rawUrl)
        {
        }
        /// <summary>
        /// List all expenses
...
#nullable enable
            ...
            public global::Soenneker.Unified.OpenApiClient.Accounting.Item.Expense.GetFieldsQueryParameterType[]? Fields { get; set; }
#nullable restore
#else
            [QueryParameter("fields")]
            public global::Soenneker.Unified.OpenApiClient.Accounting.Item.Expense.GetFieldsQueryParameterType[] Fields { get; set; }
...
#nullable enable
            [QueryParameter("fields")]
            public global::Soenneker.Unified.OpenApiClient.Accounting.Item.Expense.PostFieldsQueryParameterType[]? Fields { get; set; }
#nullable restore
#else
            [QueryParameter("fields")]
            public global::Soenneker.Unified.OpenApiClient.Accounting.Item.Expense.PostFieldsQueryParameterType[] Fields { get; set; }
