...
{
    /// <summary>
    /// Builds and executes requests for operations under \accounting\{connection_id}\order
    /// </summary>
    ...
    public partial class OrderRequestBuilder : BaseRequestBuilder
    {
        ...
        public OrderRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounting/{connection_id}/order{?contact_id*,fields*,limit*,offset*,order*,org_id*,query*,raw*,sort*,type*,updated_gte*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Unified.OpenApiClient.Accounting.Item.Order.OrderRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public OrderRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounting/{connection_id}/order{?contact_id*,fields*,limit*,offset*,order*,org_id*,query*,raw*,sort*,type*,updated_gte*}", rawUrl)
        {
        }
        /// <summary>
        /// List all orders
...
#nullable enable
            ...
            public global::Soenneker.Unified.OpenApiClient.Accounting.Item.Order.GetFieldsQueryParameterType[]? Fields { get; set; }
#nullable restore
#else
            [QueryParameter("fields")]
            public global::Soenneker.Unified.OpenApiClient.Accounting.Item.Order.GetFieldsQueryParameterType[] Fields { get; set; }
...
#nullable enable
            [QueryParameter("fields")]
            public global::Soenneker.Unified.OpenApiClient.Accounting.Item.Order.PostFieldsQueryParameterType[]? Fields { get; set; }
#nullable restore
#else
            [QueryParameter("fields")]
            public global::Soenneker.Unified.OpenApiClient.Accounting.Item.Order.PostFieldsQueryParameterType[] Fields { get; set; }
