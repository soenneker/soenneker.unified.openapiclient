...
namespace Soenneker.Unified.OpenApiClient.Accounting.Item.Project
{
    ...
    public partial class ProjectRequestBuilder : BaseRequestBuilder
    {
        ...
        public ProjectRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounting/{connectionId}/project{?contact_id*,fields*,is_active*,limit*,offset*,order*,org_id*,parent_id*,query*,raw*,sort*,status*,updated_gte*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Unified.OpenApiClient.Accounting.Item.Project.ProjectRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProjectRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounting/{connectionId}/project{?contact_id*,fields*,is_active*,limit*,offset*,order*,org_id*,parent_id*,query*,raw*,sort*,status*,updated_gte*}", rawUrl)
        {
        }
        /// <summary>
        /// List all projects
